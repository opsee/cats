...
type GetChecksResponse struct {
	Check []*opsee2.Check `protobuf:"bytes,1,rep,name=check" json:"check,omitempty"`
}
...
func (m *GetChecksResponse) GetCheck() []*opsee2.Check {
	if m != nil {
		return m.Check
	}
	return nil
...
func (this *GetChecksResponse) Equal(that interface{}) bool {
	...
	if len(this.Check) != len(that1.Check) {
		return false
	}
	for i := range this.Check {
		if !this.Check[i].Equal(that1.Check[i]) {
			return false
		}
	}
	return true
...
func NewPopulatedGetChecksResponse(r randyCats, easy bool) *GetChecksResponse {
	...
	if r.Intn(10) != 0 {
		v5 := r.Intn(5)
		this.Check = make([]*opsee2.Check, v5)
		for i := 0; i < v5; i++ {
			this.Check[i] = opsee2.NewPopulatedCheck(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func (m *GetChecksResponse) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Check = append(m.Check, &opsee2.Check{})
...
var fileDescriptorCats = []byte{
	...
	,
}
